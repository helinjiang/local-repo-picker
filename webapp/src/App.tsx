...
export default function App() {
  ...
  }, [debouncedQuery, tag, page, pageSize, messageApi, selectedPath]);
        ...
        <div className="toolbar">
          <div className="toolbar-row">
            ...
            <div className="toolbar-group toolbar-group--actions">
              <Space>
                <Button icon={<ReloadOutlined />} onClick={handleRefresh} loading={refreshingCache}>
                  刷新缓存
                </Button>
        ...
        >
          ...
          <Space direction="vertical" size="middle" style={{ width: '100%' }}>
            {!currentRepoLinksGroup ? (
              ...
              >
                ...
                <Space direction="vertical" size="small" style={{ width: '100%', marginTop: 12 }}>
                  ...
                  <Button
                    icon={<PlusOutlined />}
                    onClick={() => handleRepoLinkAdd(currentRepoLinksIndex)}
                  >
                    添加链接
                  </Button>
                </Space>
            ...
            <div style={{ color: '#8c8c8c', fontSize: 12 }}>
              Key 为 repoKey（provider:fullName），匹配后展示。支持占位符：{`{ownerRepo}`}、
              {`{path}`}、{`{originUrl}`}
            </div>
          </Space>
        </Modal>
